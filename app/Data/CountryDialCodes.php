...
/**
 * Country dial codes for the phone-input partial. Generated from the React
 * PhoneInput component (full ITU list) so both frontends stay in sync.
 */
class CountryDialCodes
{
    /** @return array<int, array{name:string, iso:string, dial:string, flag:string}> */
    public static function all(): array
    {
        return [
            ...
            ['name' => 'American Samoa', 'iso' => 'AS', 'dial' => '+1', 'flag' => '🇦🇸'],
            ['name' => 'Andorra', 'iso' => 'AD', 'dial' => '+376', 'flag' => '🇦🇩'],
            ['name' => 'Angola', 'iso' => 'AO', 'dial' => '+244', 'flag' => '🇦🇴'],
            ['name' => 'Anguilla', 'iso' => 'AI', 'dial' => '+1', 'flag' => '🇦🇮'],
            ['name' => 'Antigua & Barbuda', 'iso' => 'AG', 'dial' => '+1', 'flag' => '🇦🇬'],
            ...
            ['name' => 'Bermuda', 'iso' => 'BM', 'dial' => '+1', 'flag' => '🇧🇲'],
            ...
            ['name' => 'British Virgin Islands', 'iso' => 'VG', 'dial' => '+1', 'flag' => '🇻🇬'],
            ...
            ['name' => 'Cayman Islands', 'iso' => 'KY', 'dial' => '+1', 'flag' => '🇰🇾'],
            ...
            ['name' => 'Dominica', 'iso' => 'DM', 'dial' => '+1', 'flag' => '🇩🇲'],
            ...
            ['name' => 'Grenada', 'iso' => 'GD', 'dial' => '+1', 'flag' => '🇬🇩'],
            ['name' => 'Guadeloupe', 'iso' => 'GP', 'dial' => '+590', 'flag' => '🇬🇵'],
            ['name' => 'Guam', 'iso' => 'GU', 'dial' => '+1', 'flag' => '🇬🇺'],
            ...
            ['name' => 'Montserrat', 'iso' => 'MS', 'dial' => '+1', 'flag' => '🇲🇸'],
            ...
            ['name' => 'Northern Mariana Islands', 'iso' => 'MP', 'dial' => '+1', 'flag' => '🇲🇵'],
            ...
            ['name' => 'St. Kitts & Nevis', 'iso' => 'KN', 'dial' => '+1', 'flag' => '🇰🇳'],
            ['name' => 'St. Lucia', 'iso' => 'LC', 'dial' => '+1', 'flag' => '🇱🇨'],
            ['name' => 'St. Vincent & Grenadines', 'iso' => 'VC', 'dial' => '+1', 'flag' => '🇻🇨'],
            ...
            ['name' => 'US Virgin Islands', 'iso' => 'VI', 'dial' => '+1', 'flag' => '🇻🇮'],
