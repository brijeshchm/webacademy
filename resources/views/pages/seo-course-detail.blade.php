                    ...
                    <section id="overview" class="scroll-mt-36 bg-white rounded-3xl border border-gray-100 shadow-sm p-4 sm:p-6 md:p-8">
                        <div class="space-y-3">
                            ...
                            @if($aboutHeading->courseabout)
                                <details class="group bg-gray-50 border border-gray-100 rounded-2xl overflow-hidden hover:shadow-md transition-shadow open:border-gray-200 open:bg-white">
                                    <summary class="px-5 py-4 cursor-pointer list-none text-left [&::-webkit-details-marker]:hidden">
                                        <div class="flex items-start gap-3 w-full">
                                            ...
                                            <span class="font-semibold text-gray-900 text-sm leading-snug flex-1">{!! $aboutHeading->heading !!}</span>
                                    ...
                                    <div class="px-5 pb-5 pt-0">
                                        <p class="text-sm text-gray-500 leading-relaxed ml-9">{!! $aboutHeading->courseabout !!}</p>
                                    </div>
                                </details>
                            @endif

                            {{-- Loop through heading1..heading6 / description1..description6 --}}
                            @for($i = 1; $i <= 6; $i++)
                                @php
                                ...
                                @if(!empty($aboutHeading->{$headingField}))
                                    <details class="group bg-gray-50 border border-gray-100 rounded-2xl overflow-hidden hover:shadow-md transition-shadow open:border-gray-200 open:bg-white">
                                        <summary class="px-5 py-4 cursor-pointer list-none text-left [&::-webkit-details-marker]:hidden">
                                            <div class="flex items-start gap-3 w-full">
                                                <div class="h-8 w-1 rounded-full bg-gradient-to-b from-blue-500 to-violet-500"></div>
                                                <span class="font-semibold text-gray-900 text-sm leading-snug flex-1">{!! $aboutHeading->{$headingField} !!}</span>
                                                <svg class="h-4 w-4 text-gray-400 shrink-0 mt-0.5 transition-transform duration-200 group-open:rotate-180" {!! $iconStroke !!}><polyline points="6 9 12 15 18 9"></polyline></svg>
                                            </div>
                                        </summary>
                                        <div class="px-5 pb-5 pt-0">
                                            <p class="text-sm text-gray-500 leading-relaxed ml-9">{!! $aboutHeading->{$descField} !!}</p>
                                        </div>
                                    </details>
                                @endif
                            @endfor
