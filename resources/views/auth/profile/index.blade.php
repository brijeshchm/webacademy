			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<br />
							<form class="form-horizontal form-label-left" role="form" method="POST" action="{{ url('/admin/profile') }}" enctype="multipart/form-data">
								{{ csrf_field() }}
								...
								<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input id="email" type="text" class="form-control col-md-7 col-xs-12" name="email" value="{{ old('email',(isset($edit_data)) ? $edit_data->email:"")}}">
								...
								<div >
								<img src="{{ URL::asset('public/uploads/profile/'.$edit_data->image)}}" style="max-width:100px;" height="100" width="100">	
								<a href="profile/del_icon/{{$edit_data->id}}" class="btn btn-inverse btn-circle m-b-5 deleteIcon"><i class="glyphicon glyphicon-trash"></i></a>
