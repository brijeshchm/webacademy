		...
		<div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<form class="form-horizontal" action="{{url('/admin/change-password')}}" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Old Password<span class="required">*</span></label>
						<div class="col-lg-6 col-sm-6 col-xs-12">
					 	{{ csrf_field()}}
							<input type="text" name="oldpwd" class="form-control" value="" placeholder="Old password">
					...
					<div class="form-group">
						   ...
						   <div class="col-lg-6 col-sm-6 col-xs-12">	          
							<div class="image">
								...
								<input type="text" name="newpwd" class="form-control" value="" placeholder="New password">
