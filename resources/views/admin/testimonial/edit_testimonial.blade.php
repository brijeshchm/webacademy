            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                    
                    <form  data-parsley-validate class="form-horizontal form-label-left" autocomplete="off" action="" onsubmit="return testimonialController.editSaveTestimonial(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)">	
  				 ...
  				 <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" name="linkedin_url" value="{{ old('linkedin_url',(isset($edit_data)) ? $edit_data->linkedin_url:"")}}" placeholder="Enter linkedin url" >
                        </div>
                      </div> 
  				 	<div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="title">Facebook</label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" name="facebook_url" value="{{ old('facebook_url',(isset($edit_data)) ? $edit_data->facebook_url:"")}}" placeholder="Enter Facebook Url" >
                        </div>
                      </div> 
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                         @if(isset($edit_data) && $edit_data->testimonial_image !='')									 
							<?php $vimage= json_decode($edit_data->testimonial_image);  ?>
							<div >
							<img src="<?php echo asset('public/'.$vimage['testimonial_image']['src']); ?>" style="max-width:100px;" height="100" width="100">	
							<a href="/admin/testimonial/del_icon/{{$edit_data->id}}" class="btn btn-inverse btn-circle m-b-5 deleteIcon"><i class="glyphicon glyphicon-trash"></i></a>
							<input type="hidden" class="" name="testimonial_image" value="{{ $edit_data->testimonial_image }}" >
							</div>
							@else											 
							<input type="file" dir="auto" name="testimonial_image" accept="image/*">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                         <?php 
						if(isset($edit_data) && $edit_data->testimonial_image !=''){	
						$altname= json_decode($edit_data->testimonial_image);   
						$alt =$altname['testimonial_image']['alt'];
						}else{
						$alt=""; 
						}
						?> 
