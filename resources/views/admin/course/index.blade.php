...
<div class="page-title">
			...
			<a href="/admin/course/add"  class="btn btn-info"> Add Course</a>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
							  ...
							  <div class="nk-int-mk">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <select class="bootstrap-select fm-cmp-mg form-control" name="search[category]" >
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-all-course" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                           <th>SEO Page</th>	
                          <th>Course name</th>
