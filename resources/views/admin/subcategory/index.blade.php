			 ...
			 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                    
                    <form class="form-horizontal form-label-left" autocomplete="off" action="" onsubmit="return subCategoryController.submit(this)" > 
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="title">Sub Category <span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" name="subcategory" value="" placeholder="Enter Category" >
                        </div>
                      </div>         
						...
						<input type="file" class="form-control col-md-7 col-xs-12" name="course_icons" value="" accept=".jpeg,.jpg,.png,.svg">
						</div>
						</div>  
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">	<span>Original Dimensions 290*196 && Max 5kb</span>						 
							<input type="file" class="form-control col-md-7 col-xs-12" name="course_image" value="" accept=".jpeg,.jpg,.png,.svg">                         
                        </div>
                      </div> 
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-all-sub-category" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>Category</th>                          
                          <th>Sub Category</th>                          
                          <th>Sub Category Icons</th>                          
