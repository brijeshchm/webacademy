				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							...
							@endif
							<h2>Update Permission <small></small></h2>
							<div class="clearfix"></div>
						</div>
						<div class="x_content">
							<br />
							<form id="role-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" onsubmit="return rolePermissionController.editRoleSaveSubmit(this,<?php echo $id; ?>)">
								{{ csrf_field() }}
