			 ...
			 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                    
                    <form class="form-horizontal form-label-left" action="#" method="POST" onsubmit="return permissionController.editSaveSubmit(this,<?php echo (isset($edit_data->id)? $edit_data->id:""); ?>)">
