			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<br />
							<form id="role-form2" class="form-horizontal form-label-left" action="#" method="POST" onsubmit="return rolePermissionController.submit(this)">
								<div class="form-group">
									<label class="col-xs-12">Role</label>
									<div class="col-xs-5">
									<input type="text" name="role" value="" class="form-control" placeholder="Enter Role Name">									 
									</div>
								</div>
								<div class="form-group">
