...
@section('content')	
  ...
  <div class="brijesh_col" role="main">
          <div class="">    
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">                    
					...
					<!--	<label class="control-label col-md-4 col-sm-4 col-xs-12" for="course" style="font-size: 19px;margin-left: -85px;font-weight: 500;">Select Course </label>-->
						<select name="course" class="form-control select_courses col-md-4 col-xs-12 get_coursellor_course">
