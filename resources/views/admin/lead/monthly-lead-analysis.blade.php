			 ...
			 <div class="row">
				   ...
				   <div class="row">
					...
					<div class="x_panel xp">
						...
						<table id="data-table-monthly-lead-analysis" class="table table-bordered table-hover table-striped">
						<thead>
						<tr>	
						<th>Date</th>						
				...
				<!-- <div class="row">
				   ...
				   <div class="row">
					...
					<div class="x_panel xp">
						...
						<table id="data-table-source-view" class="table table-striped table-bordered">
						<thead>
						<tr>					 
